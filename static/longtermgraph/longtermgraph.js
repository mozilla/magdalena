...
var gBranches = {
    ...
    fxaurora: {
        title: "Firefox Beta / DevEdition channel",
...
function fetchFile(type, aCallback) {
    $.getJSON(gDataPath + type, {
        "product": gBranches[gSelID].product,
        "channel": gBranches[gSelID].channel
    }, aCallback);
}
